...
| カラム名                           | 説明・役割                                                                                                                                                                                                                                                |
|-----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **ONTENT_TYPE**                   | 記事の投稿タイプ（例: “column”など）。一覧作成時のフィルタに利用。                                                                                                                                                                                       |
...
\]<br>
プラスの値が大きいほど、最近順位が上がっている（改善している）ことを示す。                                                                                                                                               |
| **SEO対策KW**                     | その記事が狙う主な SEO キーワード。                                                                                                                                                                                                                      |
